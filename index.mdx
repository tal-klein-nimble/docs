...
<Columns cols={2}>
  <Card
    ...
    href=""
  >
    High-performance proxy network with advanced stealth capabilities
  </Card>
  <Card title="Web API" icon="browser" href="">
    Browser automation and data extraction API for dynamic content
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="circle-check"
    href="https://status.nimbleway.com/"
  >
