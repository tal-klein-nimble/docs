...
<Columns cols={2}>
  <Card title="Proxy Infrastructure" icon="globe" href="documentation/web-tools/proxy/proxy-quickstart">
    High-performance residential proxy network with advanced stealth capabilities
  </Card>
  <Card title="Web Tools" icon="code" href="documentation/web-tools/extract/extract-quickstart">
