---
title: "Crawl Usage"
description: "Comprehensive guide to crawling entire websites and discovering URLs automatically"
---

The Crawl API enables you to crawl entire websites and discover URLs automatically. It intelligently follows sitemaps, internal links, and optionally external links based on your configuration, making it easy to map out entire domains.
...
```python
# ✅ Good: Specific patterns for blog posts
result = nimble.crawl({
    "url": "https://www.example.com",
