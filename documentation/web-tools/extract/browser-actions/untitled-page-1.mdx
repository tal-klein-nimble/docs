...
result = nimble.extract({
    ...
    "render": True,
    "llm_prompt": "Search for 'laptop' and filter by 'On Sale' items"
})
...
result = nimble.extract({
    ...
    "render": True,
    "llm_prompt": "Scroll down until all products are loaded"
})
...
result = nimble.extract({
    "url": "https://www.example.com",
    "render": True,
    "llm_prompt": "Click the filters button, set price range to $500-$1000, select 4-star rating and above, then apply filters"
})
