...
1. Define actions in the `browser_actions` array
...
1. Send a natural language prompt (e.g., "scroll until all items load, open filters, click 'On Sale'")
...
result = nimble.extract({
    "url": "https://www.example.com",
    "render": True,
    "llm_prompt": "Search for 'laptop' and apply filters for 'On Sale' items"
})
