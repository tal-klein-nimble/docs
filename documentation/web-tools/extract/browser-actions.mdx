...
description: "Interact with webpages through clicks, typing, scrolling, and more"
---

Browser Actions let you perform operations on webpages before data collection, including clicking, typing, scrolling, and capturing screenshots. These interactions are essential for accessing dynamically loaded content on modern websites.
...
- `required` (optional) - Set to `false` to make this step optional and continue execution on failure (default: `true`)
